...
train_data=pd.read_csv('arcene_train.data', sep=' ', header=None).dropna(1)
train_labels=pd.read_csv('arcene_train.labels', sep=' ', header=None)
test_data=pd.read_csv('arcene_valid.data', sep=' ', header=None).dropna(1)
test_labels=pd.read_csv('arcene_valid.labels', sep=' ', header=None)
