...
alldata=pd.read_csv('covtype.data', sep=',', header=None).as_matrix()
np.random.shuffle(alldata)
train_data=alldata[:5000,:54]
print(train_data)
train_labels=np.expand_dims(alldata[:5000,-1], axis=1)-1
test_data=alldata[5000:6000,:54]
test_labels=np.expand_dims(alldata[5000:6000,-1], axis=1)-1
print(test_labels)
